...
public class Nave
{
    ...
    {                       
        ...
        posY = 200;
        estaViva = true;
        // Exercício 2.6 - Proteção volta para 100
        nivelDeProtecao = 100;
    }
    ...
    {
        // Exercício 2.7 - Exibe nome e proteção
        return nome + " - Proteção: " + nivelDeProtecao;
    }
    ...
    public void tomarTiro()
    {
        if (estaViva)
        {
            // Exercício 2.6 - Perde 20 de proteção
            nivelDeProtecao -= 20;
